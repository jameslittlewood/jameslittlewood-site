...
Developing and refining practical skills in SQL, Excel, Tableau, Python, Git, Shell and Snowflake through structured learning, self-directed projects and hands-on technical workflows. Maintain a personal Ubuntu-based development environment using PostgreSQL, Docker, VS Code Remote SSH and DBeaver to practise database administration, containerised workflows and remote development.
